    ...
    class DependencyProvider
    {
            ...
            TargetingPackDependencyInstaller targetingPackInstaller)
        {
            ...
            dependencies = new Dependency[]
            {
                ...
                new ChocolateyPackageDependency("opencover.portable",                 minimumVersion: "4.7.922.0", commandName: "opencover.console", displayName: WellKnownDependency.OpenCover),
                new ChocolateyPackageDependency("reportgenerator.portable",           minimumVersion: "3.0.0.0",   commandName: "reportgenerator",   displayName: WellKnownDependency.ReportGenerator),
