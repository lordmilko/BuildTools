...
namespace BuildTools.Cmdlets
{
    ...
    [BuildCommand(CommandKind.UpdateVersion, CommandCategory.Version, Feature.Version)]
    public abstract class UpdateVersion<TEnvironment> : BuildCmdlet<TEnvironment>, ILegacyProvider
    {
        ...
        {
            var getVersionName = commandService.GetCommandNameOrDefault(CommandKind.GetVersion);
...
If you wish to decrement the build version or change the major, minor or revision version components, you can do so by overwriting the entire version using the {setVersionName} cmdlet.

For more information on the version components that may be processed, please see Get-Help {getVersionName}";
